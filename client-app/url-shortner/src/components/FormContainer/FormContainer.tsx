...
const FormContainer: React.FunctionComponent<IFormContainerProps> = () => {
  ...
  return (
    <div className="container mx-auto p-2">
        ...
        <p className='text-white text-center pb-4 text-sm font-thin'>Free tool to shorten a URL or reduce link, Use our URL shortner to create a shortened & neat link making it easy to access</p>
        <form onSubmit={handleSubmit}>
            <div className='flex'>
                <div className='relative w-full '>
                    ...
                    <input type='text' placeholder='add your link' required className='block  w-full p-4 ps-32 text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500'
                    value={fullUrl}
